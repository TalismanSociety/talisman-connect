(function (global, factory) {
  ...
  function decodeAbstractInt(value, isNegative) {
    if (util.isBn(value)) {
      ...
      util.assert(value <= Number.MAX_SAFE_INTEGER && value >= Number.MIN_SAFE_INTEGER && Number.isInteger(value), 'Number needs to be an integer <= Number.MAX_SAFE_INTEGER, i.e. 2 ^ 53 - 1');
