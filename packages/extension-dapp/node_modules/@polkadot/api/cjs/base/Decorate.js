...
class Decorate extends _Events.Events {
  ...
  _decorateStorageRange(decorated, args, range) {
    ...
    return this._rpcCore.state.queryStorage([decorated.key(...args)], ...range).pipe((0, _rxjs.map)(result => result.map(_ref4 => {
      let [blockHash, [value]] = _ref4;
  ...
  _retrieveMapKeys(_ref5, at, args) {
    let {
      iterKey,
      meta,
      method,
  ...
  _retrieveMapKeysPaged(_ref6, at, opts) {
    let {
      iterKey,
      meta,
      method,
