...
class WsProvider {
  ...
  async connect() {
    try {
      ...
      (0, _classPrivateFieldLooseBase2.default)(this, _timeoutId)[_timeoutId] = setInterval(() => (0, _classPrivateFieldLooseBase2.default)(this, _timeout)[_timeout](), TIMEOUT_INTERVAL);
    } catch (error) {
      l.error(error);
...
async function _send2(json, method, params, subscription) {
  return new Promise((resolve, reject) => {
    try {
      ...
      (0, _classPrivateFieldLooseBase2.default)(this, _stats)[_stats].total.bytesSent += json.length;
