...
class Keyring {
  ...
  encodeAddress = (address, ss58Format) => {
    return this.type === 'ethereum' ? (0, _utilCrypto.ethereumEncode)(address) : (0, _utilCrypto.encodeAddress)(address, (0, _util.isUndefined)(ss58Format) ? this.#ss58 : ss58Format);
  };
  /**
   * @name getPair
