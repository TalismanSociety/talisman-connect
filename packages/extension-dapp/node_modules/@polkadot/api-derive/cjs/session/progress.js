...
function withProgressField(field) {
  return (instanceId, api) => (0, _util.memo)(instanceId, () => api.derive.session.progress().pipe((0, _rxjs.map)(info => info[field])));
}
...
function progress(instanceId, api) {
  return (0, _util.memo)(instanceId, () => api.query.babe ? queryBabe(api).pipe((0, _rxjs.map)(_ref3 => {
