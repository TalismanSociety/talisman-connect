...
function accounts(instanceId, api) {
  return (0, _util2.memo)(instanceId, accountIds => api.derive.session.info().pipe((0, _rxjs.switchMap)(sessionInfo => (0, _rxjs.combineLatest)([api.derive.staking.keysMulti(accountIds), api.derive.staking.queryMulti(accountIds, QUERY_OPTS)]).pipe((0, _rxjs.map)(_ref5 => {
...
const account = (0, _util2.firstMemo)((api, accountId) => api.derive.staking.accounts([accountId]));
