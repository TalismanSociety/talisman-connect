...
class ScProvider {
  ...
  async connect(config) {
    ...
    this.#chain = addChain(this.#spec, onResponse).then(chain => {
      ...
      const killStaleSubscriptions = () => {
        ...
        (0, _util.assert)(stale, 'Unable to get stale subscription');
        const {
          id,
          unsubscribeMethod
        } = stale;
  ...
  async send(method, params) {
    (0, _util.assert)(this.isConnected && this.#chain, 'Provider is not connected');
    const chain = await this.#chain;
  ...
  async subscribe(type, method, params, callback) {
    ...
    (0, _util.assert)(unsubscribeMethod, 'Invalid unsubscribe method found');
