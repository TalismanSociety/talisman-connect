...
export declare type JsonRpcCallback = (response: string) => void;
export declare type AddChain = (chainSpec: string, jsonRpcCallback?: JsonRpcCallback) => Promise<Chain>;
export declare type AddWellKnownChain = (id: WellKnownChain, jsonRpcCallback?: JsonRpcCallback) => Promise<Chain>;
/**
