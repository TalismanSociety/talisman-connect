import type { AnyJson, Codec, CodecClass, Registry } from '../types';
...
export declare class WrapperKeepOpaque<T extends Codec> extends Bytes {
    #private;
    constructor(registry: Registry, typeName: CodecClass<T> | string, value?: unknown, opaqueName?: OpaqueName);
